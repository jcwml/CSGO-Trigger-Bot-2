...
void processScanArea(Window w)
{
    ...
    for(int y = 0; y < r0; y++)
    {
        for(int x = 0; x < r0; x++)
        {
            ...
            // -1 to +1 normalised
            input[0][y][x] = (((float)c.red)-32767.5f)*3.051800013e-05f;
            input[1][y][x] = (((float)c.green)-32767.5f)*3.051800013e-05f;
            input[2][y][x] = (((float)c.blue)-32767.5f)*3.051800013e-05f;
        }
    }
